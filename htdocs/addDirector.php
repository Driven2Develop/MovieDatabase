...
input[type="submit"]:hover{
  ...
  cursor:pointer;
		...
		if(array_key_exists('save',$_POST))
		{
			...
			$query = "INSERT INTO movie_recommender.directordirects
			...
			pg_close($dbconn);	
			header('Location: http://localhost/addedDirector.html');
		}
	?>	
	<body>
		<form class="form" name="form" method="post" action="">
		<p> <label for="idirectorID">Director ID:</label>
				<input name="idirectorID" type ="text" id="idirectorID"/>
			</p>
			<p> <label for="imovieID">Movie ID:</label>
				<input name="imovieID" type="password" id="imovieID"/>
			</p>
